...
DASHBOARD_STRINGS = {
    'ar': {
        ...
        'LBL_RESET_DATA': "إعادة تعيين البيانات ♻️",
        'LBL_GLOBAL_RESET': "إعادة تعيين شاملة (حذف كل المهام والسحوبات)",
        'LBL_GLOBAL_RESET_DESC': "يقوم بحذف جميع إحصائيات المستخدمين وأرصدتهم، ولكنه يحتفظ بحساباتهم مسجلة.",
        'LBL_USER_RESET': "إعادة تعيين بيانات مستخدم محدد",
        'LBL_USER_RESET_DESC': "يقوم بتصفير رصيد وإحصائيات مستخدم محدد فقط مع الاحتفاظ بحسابه.",
        ...
        'LBL_DANGER_ZONE': "منطقة الخطر ⚠️",
        'LBL_DELETE_ALL_USERS': "حذف جميع المستخدمين وبياناتهم",
        'LBL_DELETE_ALL_DESC': "يقوم بحذف جميع المستخدمين وكل البيانات المرتبطة بهم نهائياً. عملية لا يمكن التراجع عنها.",
        'BTN_DELETE_ALL_USERS': "حذف الكل نهائياً ☠️",
        'LBL_DELETE_SPECIFIC_USER': "حذف مستخدم محدد بكل بياناته",
        'LBL_DELETE_SPECIFIC_DESC': "يقوم بحذف مستخدم واحد وكل بياناته نهائياً. عملية لا يمكن التراجع عنها.",
    ...
    'en': {
        ...
        'LBL_RESET_DATA': "Data Reset ♻️",
        'LBL_GLOBAL_RESET': "Global Reset (Clear all tasks & withdrawals)",
        'LBL_GLOBAL_RESET_DESC': "Clears all user statistics and balances, but keeps registered users.",
        'LBL_USER_RESET': "Specific User Reset",
        'LBL_USER_RESET_DESC': "Clears specific user statistics and balances, but keeps the account.",
        'LBL_USER_ID': "User ID",
        ...
        'LBL_DANGER_ZONE': "Danger Zone ⚠️",
        'LBL_DELETE_ALL_USERS': "Delete All Users & Their Data",
        'LBL_DELETE_ALL_DESC': "Completely removes all users and their associated records. Irreversible.",
        'BTN_DELETE_ALL_USERS': "Delete All Permanently ☠️",
        'LBL_DELETE_SPECIFIC_USER': "Delete Specific User & All Data",
        'LBL_DELETE_SPECIFIC_DESC': "Completely removes a single user and all associated records. Irreversible.",
        'BTN_DELETE_SPECIFIC_USER': "Delete User Permanently 🗑️",
