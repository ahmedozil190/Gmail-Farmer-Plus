...
DASHBOARD_STRINGS = {
    'ar': {
        ...
        'NAV_CUSTOM_PRICES': "الأسعار المخصصة",
        'DASH_CP_PAGE_TITLE': "إدارة التسعير المخصص (VIP)",
        'DASH_CP_MANUAL': "اليدوي:",
        'DASH_CP_AUTO': "الآلي:",
    ...
    'en': {
        ...
        'NAV_CUSTOM_PRICES': "VIP Prices",
        'DASH_CP_PAGE_TITLE': "Custom Pricing Management",
        'DASH_CP_MANUAL': "Manual:",
        'DASH_CP_AUTO': "Auto:",
